 ...
 * @author lakii
 */
public class mass_murder extends javax.swing.JFrame {

    private ResultSet rs;

    /**
     * Creates new form mass_murder
     */
    public mass_murder() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(170, 320, 1460, 270);
        ...
        jButton1.setBounds(800, 110, 200, 60);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Criminalrecordsdatabasesystem/massmurder(JU1Ud4YFBoV).jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, -280, 2680, 1650);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String sql = "select * from CRIMINAL where CATEGORY='MASS MURDER'";
...
TableModel model = jTable1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mass_murder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mass_murder().setVisible(true);
            }
        });
    }
