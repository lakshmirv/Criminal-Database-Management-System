 ...
 * @author lakii
 */
public class rampage_killer extends javax.swing.JFrame {

    private ResultSet rs;

    /**
     * Creates new form rampage_killer
     */
    public rampage_killer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(210, 270, 1460, 269);
        ...
        jButton1.setBounds(800, 160, 200, 60);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Criminalrecordsdatabasesystem/rampagekiller(u5TV6dlicj0).jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 0, 2210, 1030);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String sql = "select * from CRIMINAL where CATEGORY='RAMPAGE KILLER'";
...
TableModel model = jTable1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rampage_killer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rampage_killer().setVisible(true);
            }
        });
    }
