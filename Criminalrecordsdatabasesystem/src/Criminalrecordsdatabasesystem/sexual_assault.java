 ...
 * @author lakii
 */
public class sexual_assault extends javax.swing.JFrame {

    private ResultSet rs;

    /**
     * Creates new form sexual_assault
     */
    public sexual_assault() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(240, 670, 1460, 271);
        ...
        jButton1.setBounds(880, 270, 200, 60);
        ...
        jButton2.setBounds(60, 950, 63, 25);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Criminalrecordsdatabasesystem/sexualassault(StKj7yc8vFZ).jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-20, -80, 2760, 1200);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String sql = "select * from CRIMINAL where CATEGORY='SEXUAL ASSAULT'";
...
TableModel model = jTable1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sexual_assault.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sexual_assault().setVisible(true);
            }
        });
    }
