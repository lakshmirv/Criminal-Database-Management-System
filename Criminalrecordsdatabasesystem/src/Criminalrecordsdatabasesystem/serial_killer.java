 ...
 * @author lakii
 */
public class serial_killer extends javax.swing.JFrame {

    private ResultSet rs;

    /**
     * Creates new form serial_killer
     */
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(160, 120, 1460, 670);
        ...
        jButton1.setBounds(770, 20, 200, 60);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Criminalrecordsdatabasesystem/serial kller.jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-40, -300, 2200, 1610);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String sql = "select * from CRIMINAL where CATEGORY='SERIAL KILLER'";
...
TableModel model = jTable1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(serial_killer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new serial_killer().setVisible(true);
            }
        });
    }
