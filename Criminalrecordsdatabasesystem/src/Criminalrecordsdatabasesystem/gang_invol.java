 ...
 * @author lakii
 */
public class gang_invol extends javax.swing.JFrame {

    private ResultSet rs;

    /**
     * Creates new form gang_invol
     */
    public gang_invol() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(170, 440, 1460, 271);
        ...
        jButton1.setBounds(790, 330, 200, 60);
        ...
        jButton2.setBounds(36, 766, 63, 25);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Criminalrecordsdatabasesystem/mafiaa(toXTV7cOztx).jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-40, -340, 2150, 1770);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String sql = "select * from CRIMINAL where CATEGORY='GANG INVOLVEMENT'";
...
TableModel model = jTable1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gang_invol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gang_invol().setVisible(true);
            }
        });
    }
