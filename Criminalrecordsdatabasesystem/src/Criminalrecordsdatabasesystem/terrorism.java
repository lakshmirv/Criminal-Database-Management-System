 ...
 * @author lakii
 */
public class terrorism extends javax.swing.JFrame {

    private ResultSet rs;

    /**
     * Creates new form terrorism
     */
    public terrorism() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(180, 550, 1460, 273);
        ...
        jButton1.setBounds(720, 170, 200, 60);
        ...
        jButton2.setBounds(30, 830, 63, 25);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Criminalrecordsdatabasesystem/terrorism(dF8vZXJ8BaI).png"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, -210, 1880, 1360);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String sql = "select * from CRIMINAL where CATEGORY='TERRORISM'";
...
TableModel model = jTable1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(terrorism.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
