 ...
 * @author lakii
 */
public class mass_shooter extends javax.swing.JFrame {

    private ResultSet rs;

    /**
     * Creates new form mass_shooter
     */
    public mass_shooter() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(170, 480, 1460, 271);
        ...
        jButton1.setBounds(780, 170, 200, 60);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Criminalrecordsdatabasesystem/mass shooter(yRWaOJkJqYd).jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-30, 6, 2930, 990);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String sql = "select * from CRIMINAL where CATEGORY='MASS SHOOTER'";
...
TableModel model = jTable1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mass_shooter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mass_shooter().setVisible(true);
            }
        });
    }
